...
function buildFlatSubcategoryList() {
  const result = [];
...
function buildCanonicalNameSet() {
  return new Set(buildFlatSubcategoryList().map((s) => s.name));
}
function buildAlternateNameMap() {
...
export {
  CATEGORY_CONFIG as C,
  getCategoryEmoji as g
};
